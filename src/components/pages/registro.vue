        ...
        <form @submit.prevent="submitForm" class="form" id="form-register" autocomplete="off" novalidate="novalidate">
          ...
          <div class="mb-3">
            ...
            <input v-model.trim="formData.password"
              :class="{ 'is-invalid': formSubmitted && (!formData.password || !isPasswordValid) }" id="register-password"
              class="form-control" autocomplete="off" type="password" placeholder="Ingrese su clave" required />
...
<script>
import FormularioMixin from '@/assets/scripts/global/FormularioMixin';
